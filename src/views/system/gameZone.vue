<template>
  <div v-if="!editState&&!adjustState&&!detailState" class="app-container calendar-list-container">
    <div class="filter-container">
      <el-select clearable style="width: 120px" class="filter-item" v-model="listQuery.importance" placeholder="会员类型">
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row
      ...
      <el-table-column align="center" min-width="152" label="注册时间">
        <template slot-scope="scope">
